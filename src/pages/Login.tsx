  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome back to eSatya!",
      });
    }, 1500);
  };

  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-navy via-brand-navy-light to-brand-navy flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      {/* Header */}
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="text-blue-100">Sign in to your eSatya account</p>
        </div>
